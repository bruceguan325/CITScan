...
{if ("" != null) return v;}
  ...
  final public ZStatement SQLStatement() throws ParseException {ZStatement s = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_COMMIT:{
      s = CommitStatement();
{if ("" != null) return s;}
...
// CommitStatement ::= COMMIT [WORK] [COMMENT <comment>];
  final public ZTransactStmt CommitStatement() throws ParseException {Token tk;
...
//   IN LockMode MODE [NOWAIT];
  final public ZLockTable LockTableStatement() throws ParseException {ZLockTable lck = new ZLockTable();
  Vector v = new Vector();
  String s;
...
// RollbackStatement ::= ROLLBACK [WORK] ["COMMENT" <comment>];
  final public ZTransactStmt RollbackStatement() throws ParseException {Token tk;
...
// SetTransactionStatement ::= SET TRANSACTION READ (ONLY | WRITE)
  final public ZTransactStmt SetTransactionStatement() throws ParseException {StringBuffer b;
...
//   | EXCLUSIVE
  final public String LockMode() throws ParseException {StringBuffer b = new StringBuffer();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_ROW:{
...
//   UPDATE TableReference SET ColumnValues [WHERE SQLExpression]
  final public ZUpdate UpdateStatement() throws ParseException {ZUpdate u;
  ZExp e;
  Hashtable t;
  String s;
  Token tk;
...
// ColumnValues ::= TableColumn = UpdatedValue (, TableColumn = UpdatedValue)*
  final public void ColumnValues(ZUpdate u) throws ParseException {String key;
  ZExp val;
    key = TableColumn();
    jj_consume_token(93);
    val = UpdatedValue();
...
// UpdatedValue ::= ( SelectStatement ) | SQLExpression
  final public ZExp UpdatedValue() throws ParseException {ZExp e;
...
// ValueSpec ::= VALUES ( SQLExpressionList )
  final public ZInsert InsertStatement() throws ParseException {ZInsert ins;
  String s;
  Vector v;
  ZQuery q;
...
// DeleteStatement ::= DELETE [FROM] TableReference [WHERE SQLExpression]
  final public ZDelete DeleteStatement() throws ParseException {ZDelete d;
  ZExp e;
  String s;
...
// QueryStatement ::= SelectStatement
  final public ZQuery QueryStatement() throws ParseException {ZQuery q;
    q = SelectStatement();
    jj_consume_token(92);
{if ("" != null) return q;}
    throw new Error("Missing return statement in function");
...
// TableReference ::= OracleObjectName[.OracleObjectName]
  final public String TableReference() throws ParseException {StringBuffer buf = new StringBuffer();
  String s;
    s = OracleObjectName();
buf.append(s);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return q;}
  ...
  final public ZQuery SelectWithoutOrder() throws ParseException {ZQuery q = new ZQuery();
  Vector select;
  Vector from;
  ZExp where = null;
...
// COUNT is an aggregate, like AVG...
  final public Vector SelectList() throws ParseException {Vector v = new Vector(8);
  ZSelectItem elem;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 104:{
...
// SelectItem() ::= SelectStar | SQLSimpleExpression() [SelectAlias]
  final public ZSelectItem SelectItem() throws ParseException {String s;
  ZSelectItem it;
  ZExp e;
...
// SelectAlias ::= (<S_IDENTIFIER>)+
  final public String SelectAlias() throws ParseException {Token tk;
  StringBuffer b = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_AS:{
...
//               OracleObjectName()"." OracleObjectName() ".*"
  final public String SelectStar() throws ParseException {String s, s2;
    if (jj_2_3(2)) {
      s = OracleObjectName();
...
// FromClause ::= FromItem (, FromItem)*
  final public Vector FromClause() throws ParseException {Vector v = new Vector(8);
  ZFromItem f;
    jj_consume_token(K_FROM);
    f = FromItem();
v.addElement(f);
...
// FromItem ::= TableReference [alias]
  final public ZFromItem FromItem() throws ParseException {ZFromItem f;
  String s;
  Token tk;
    s = TableReference();
f = new ZFromItem(s);
...
{if ("" != null) return f;}
  ...
  final public ZExp WhereClause() throws ParseException {ZExp e;
    jj_consume_token(K_WHERE);
    e = SQLExpression();
{if ("" != null) return e;}
    throw new Error("Missing return statement in function");
  ...
  final public ZGroupBy GroupByClause() throws ParseException {ZGroupBy g = null;
  Vector v;
  ZExp e;
...
// Qry ::= SelectWithoutOrder | ( SelectWithoutOrder )
  final public ZExpression SetClause() throws ParseException {ZExpression e;
  ZQuery q;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_UNION:{
...
{if ("" != null) return e;}
  ...
  final public Vector OrderByClause() throws ParseException {Vector v = new Vector();
  ZExp e;
  ZOrderBy ob;
...
{if ("" != null) return v;}
  ...
  final public ZExp SQLExpression() throws ParseException {ZExp e1, e2;
  ZExpression e = null;
  boolean single = true;
    e1 = SQLAndExpression();
    label_10:
...
{if ("" != null) return (single ? e1 : e);}
  ...
  final public ZExp SQLAndExpression() throws ParseException {ZExp e1, e2;
  ZExpression e = null;
  boolean single = true;
...
{if ("" != null) return (single ? e1 : e);}
  ...
  final public ZExp SQLUnaryLogicalExpression() throws ParseException {ZExp e1, e;
  boolean not = false;
    if (jj_2_6(2)) {
      e = ExistsClause();
{if ("" != null) return e;}
...
if(not) e = new ZExpression("NOT", e1);
  ...
  final public ZExpression ExistsClause() throws ParseException {ZExpression e;
  ZQuery q;
  boolean not = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_NOT:{
...
//      | SQLInClause | SQLBetweenClause | SQLLikeClause | IsNullClause )?
  final public ZExp SQLRelationalExpression() throws ParseException {ZExp e1, eleft;
...
if(eright == null) {if ("" != null) return eleft;}
  ...
  final public Vector SQLExpressionList() throws ParseException {Vector v = new Vector(8);
  ZExp e;
...
{if ("" != null) return v;}
  ...
  final public ZExpression SQLRelationalOperatorExpression() throws ParseException {ZExpression e;
  ZExp e1, eright;
  String op;
  String unaryOp = null;
    op = Relop();
...
e.addOperand(eright); {if ("" != null) return e;}
  ...
  final public ZExp SQLSimpleExpressionOrPreparedCol() throws ParseException {ZExp e;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_AVG:
    case K_COUNT:
    case K_MAX:
...
{if ("" != null) return new ZExpression("?");}
  ...
  final public ZExpression SQLInClause() throws ParseException {ZExpression e;
  ZQuery q;
  boolean not = false;
  Vector v;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e;}
  ...
  final public ZExpression SQLBetweenClause() throws ParseException {ZExpression e;
  ZExp  e1, e2;
  boolean not = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_NOT:{
...
if(not) e = new ZExpression("NOT BETWEEN", e1, e2);
  ...
  final public ZExpression SQLLikeClause() throws ParseException {ZExp eright;
  ZExpression e;
  boolean not = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case K_NOT:{
...
if(not) e = new ZExpression("NOT LIKE", eright);
  ...
  final public ZExpression IsNullClause() throws ParseException {boolean not = false;
...
// OP ::= + | - | "||"
  final public ZExp SQLSimpleExpression() throws ParseException {Token op;
  ZExp e1, e2;
  ZExpression e = null;
...
// OP ::= * | /
  final public ZExp SQLMultiplicativeExpression() throws ParseException {Token op;
  ZExp e1, e2;
  ZExpression e = null;
...
// SQLExpotentExpression ::= SQLUnaryExpression (** SQLUnaryExpression)*
  final public ZExp SQLExpotentExpression() throws ParseException {Token op;
  ZExp e1, e2;
  ZExpression e = null;
  boolean single = true;
...
// SQLUnaryExpression ::= [+|-] SQLPrimaryExpression
  final public ZExp SQLUnaryExpression() throws ParseException {Token op = null;
  ZExp e1, e;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 102:
    case 103:{
...
//   | COUNT(*)
//   | <NUMBER> | <STRING> | <BIND>
  final public ZExp SQLPrimaryExpression() throws ParseException {Token t;
...
{if ("" != null) return t.toString();}
  ...
  final public ZExpression FunctionCall() throws ParseException {Token t;
  String s;
  ZExpression e;
  Vector parm = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return s + "(+)";}
  ...
  final public ZQuery SubQuery() throws ParseException {ZQuery q;
    q = SelectWithoutOrder();
{if ("" != null) return q;}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3R_135()
 {
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xc0,0x4000000,0x2000000,0xc0,0x10,0x0,0x10,0x400,0x0,0x4000000,0x0,0x400,0x0,0x800,0x0,0x10,0x10,0x0,0x40000,0x100,0x4000000,0x2e41001,0x4000000,0x2000000,0x20,0x0,0x100,0x40000000,0x40000000,0x840000,0xa0000000,0x40000000,0x0,0x0,0x41000,0x0,0x0,0x0,0x0,0x100,0x0,0x0,0x8,0x4000000,0x2e41001,0x840000,0x2e41001,0x0,0x40000,0x840000,0x4000000,0x40000,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x0,0x4000000,0x0,0x0,0x4000000,0x0,0x0,0x0,0x0,0x2e41001,0x0,0x0,0x2e41001,0xa0000000,0x0,0xa0000000,0x4000000,0x0,0x0,0x0,0x2e41001,0x2e41001,0x0,0x2e41001,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2e41000,0x1,0x40001,0x2e41001,0x40000000,0x40000000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4c0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3f,0x0,0xc0,0xc0,0xc0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1c0,0x0,0xc0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0,0x0,0x0,0xc0,0x3f,0x0,0x3f,0x0,0x0,0x0,0x0,0x4c0,0x4c0,0x0,0x4c0,0x0,0x0,0x0,0x8c0,0x8c0,0x1100,0x1100,0x2000,0xc0,0xc0,0x0,0x0,0x0,0x0,0x0,0x4c0,0x0,0x0,};
   }
