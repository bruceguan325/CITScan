<%@page import="com.intumit.solr.robot.connector.webline.RichMessage"%>
...
<meta charset="utf-8">
<title><bean:message key='qa.richmessage.navbar.webline'/></title>
...
.msgImg {
    ...
    background: white url(<%= request.getContextPath() %>/wiseadm/webLine/img/noImg_image_90x90.png) no-repeat center center;
}
.richMessageTypeDiv {
	padding: 25px;
}
...
<div id="top" class="container">
	...
	<h3><bean:message key='qa.richmessage.navbar.webline'/><bean:message key='global.batch.import'/><br></h3><br> 
	<form name="UploadForm" enctype="multipart/form-data" method="post" action="<%= request.getContextPath() %>/wiseadm/webLine/qaRichMessageUploadFile?action=" onsubmit="return submitForm(this);">
...
var RichMessageListView = Backbone.View.extend({
	...
	onExportRichMessages: function() {
		window.location = '<%=request.getContextPath() %>/wiseadm/webLine/exportRichMessageAnswers.jsp?action=export';
	}
});
