...
$(document).ready(function() {
	$(".btnExport").click(function() {
		window.location = '<%=request.getContextPath() %>/wiseadm/webLine/exportRichMenu.jsp?action=export';
	});
});
</script>
</head>
...
<div id="top" class="container">
	<% if (AdminGroup.C > 0 && AdminGroup.U > 0) { %>
  	<br>
	<form name="UploadForm" enctype="multipart/form-data" method="post" action="<%= request.getContextPath() %>/wiseadm/webLine/qaRichMenuUploadFile?action=import">
    	<table width="100%">
    		<tr>
