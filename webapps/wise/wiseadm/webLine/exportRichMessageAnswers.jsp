...
import="com.intumit.solr.robot.connector.webline.RichMessage"
...
response.setHeader("Content-Disposition", "inline; filename=" + new Date().getTime() + "_RichMessage-WebLine.csv");
