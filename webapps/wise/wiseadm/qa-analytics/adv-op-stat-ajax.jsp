...
%><%
	...
	try {
		...
		if ("date".equals(xAxisDataField)) {
			...
			String addtionalFilterForGetXAxis = "TenantId_i:"+t.getId();
			Set<String> whiteFF = new HashSet<String>();

			if ("questionType".equals(xAxisDataField)) {
				xAxisFacetName = "QuestionType_s";
			}
			else if ("questionCategory".equals(xAxisDataField)) {
				xAxisFacetName = "QuestionCategory_ms";
			}
			else if ("questionKeyword".equals(xAxisDataField)) {
				xAxisFacetName = "QuestionKeyword_ms";
			}
			else if ("matchedQuestion".equals(xAxisDataField)) {
				xAxisFacetName = "MatchedQuestion_s";
			}
			else if ("kp".equals(xAxisDataField)) {
				xAxisFacetName = "KnowledgePoint_ms";
			}
			else if ("confidence".equals(xAxisDataField)) {
				xAxisFacetName = "Confidence_s";
			}
			else if ("answerType".equals(xAxisDataField)) {
				xAxisFacetName = "AnswerType_s";
			}
			else if ("tenant".equals(xAxisDataField)) {
				xAxisFacetName = "TenantId_i";
			}
			else if ("identity".equals(xAxisDataField)) {
				xAxisFacetName = "Identity_s";
			}
			else if ("opinion".equals(xAxisDataField)) {
				xAxisFacetName = "ClassifiedOpinion_s";
			}
			else if ("eservice".equals(xAxisDataField)) {
				xAxisFacetName = "Eservice_s";
			}
			else if ("questionTag".equals(xAxisDataField)) {
				xAxisFacetName = "QuestionTag_ms";
			}
			else if ("userType".equals(dataField)) {
				xAxisFacetName = "UserType_s";
			}

			List<String> xAxisFacetValues = com.intumit.solr.robot.QAUtil.getAllPossibleFacetTerms(t.getStatisticsSolrServer(), xAxisFacetName, addtionalFilterForGetXAxis);
		...
		multiCoreQ
				.setFacetLimit(xAxisDataNum).setFacetMinCount(1)
				.setParam("f.Source_s.facet.limit", "" + xAxisDataNum)
				.setParam("f.Tag_ms.facet.limit", "" + xAxisDataNum)
				.setParam("f.UserCategory_ms.facet.limit", "" + xAxisDataNum)
				.setParam("f.UserKeyword_ms.facet.limit", "" + xAxisDataNum);
