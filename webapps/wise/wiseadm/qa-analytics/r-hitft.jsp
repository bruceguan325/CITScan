	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            ...
	            <div class='col-md-12'>
		            <div class='col-md-3'>
						    ...
						    <select id="dataField" name="dataField" class="optionPanel">
						    ...
						    <select id="groupField" name="groupBy" class="optionPanel">
		            ...
		            <div class='col-md-3'>
		            		<bean:message key="search.dataField.selectAmount"/>：
						    <select id="dataNum" name="dataNum" class="optionPanel">
		            ...
		            <div class='col-md-3'>
						    ...
						    <select id="dataSmoothing" name="dataSmoothing" class="optionPanel">
        		...
        		<div class='row'>
	            	<div class='col-md-12'>
					    <p id="copyright" style="margin-left: 30px;"><font color="red"></font><span>All rights reserved.<span>|</span>© 1999-2016 <a href="http://www.intumit.com/">Intumit Inc.</a></p>
		            </div>
				</div>
	        </div>
      	<% } %>
...
<script type="text/javascript">//<![CDATA[
	...
	$('#main').height(newHeight - 120);//Math.max(newHeight - 70, newHeight - $('#main').position().top - 70));
	...
	var baseDataUrl = "<%= request.getContextPath() %>/wiseadm/qa-analytics/s-hitft-ajax.jsp?<%= query.toString() %>"
	...
	function drawChart() {
	  	...
	  	var dataUrl = baseDataUrl + "&deep=true&df=" + dataField + "&num=" + dataNum + "&dsm=" + dataSmoothing + "&groupBy=" + groupField;
        ...
        onGroupClick: function(event) {
          if (event.shiftKey) {
            ...
            this.open({
        	  ...
        	  var addFq = event.group.fq;
        	  document.location='<%= request.getContextPath() %>/wiseadm/qa-analytics/s.jsp?v=s<%= fqs %>&fq=' + encodeURIComponent(addFq);
          }
        },
