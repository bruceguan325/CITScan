...
navLinks = new String[] {"index.jsp", "#", "#"};
navIcons = new String[] {"icon-dashboard", "icon-star", "icon-wrench"};
navTitles = new String[] {MessageUtil.getMessage((Locale)request.getSession().getAttribute("org.apache.struts.action.LOCALE"), "global.homepage"), MessageUtil.getMessage(request.getLocale(), "my.favorite"), MessageUtil.getMessage(request.getLocale(), "global.config")};
