...
<%
	...
	DataSet ds = DataSetFacade.getInstance().get(targetDsId);
	{
		...
		ds.setFacets("QuestionType_s,QuestionCategory_ms,AnswerType_s,Confidence_s,KnowledgePoint_ms,QuestionKeyword_ms,Eservice_s,QuestionTag_ms,UserType_s,EventTypeCode_s,Identity_s");
		...
		ds.setFilters("+SpecialMark_s:QAMessage +TenantId_i:" + t.getId());
	}
