...
public class LineEntityProcessor extends EntityProcessorBase {
  ...
  public static ThreadLocal<Long> localLineNo = new ThreadLocal<Long>();
  ...
  public Map<String, Object> nextRow() {
    ...
    while ( true ) { 
	  ...
	  long lineNo = localLineNo.get() == null ? 1 : localLineNo.get();
	  row.put("rawLineNo", lineNo);
	  localLineNo.set( ++lineNo );
