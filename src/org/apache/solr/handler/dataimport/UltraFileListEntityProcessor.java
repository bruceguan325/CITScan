 ...
 * @see Pattern
 */
public class UltraFileListEntityProcessor extends EntityProcessorBase {
  /**
  ...
  private Date getDate(String dateStr) {
    ...
    if (m.find()) {
      ...
      try {
        return new DateFormatEvaluator().getDateMathParser(Locale.ROOT, TimeZone.getDefault()).parseMath(expr);
