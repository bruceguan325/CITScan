...
public class HTMLStripTransformer extends Transformer {
  ...
  public Object transformRow(Map<String, Object> row, Context context) {
    ...
    for (Map<String, String> field : fields) {
      ...
      String srCol = field.get(DataImporter.COLUMN);
      
      if (field.containsKey(RegexTransformer.SRC_COL_NAME)) {
    	  srCol = field.get(RegexTransformer.SRC_COL_NAME);
      }
      
      String splitHTML = context.replaceTokens(field.get(STRIP_HTML));
      if (!TRUE.equals(splitHTML))
        continue;
      Object tmpVal = row.get(srCol);
      if (tmpVal == null)
        continue;
      ...
      if (tmpVal instanceof List) {
        ...
        for (String input : inputs) {
          if (input == null)
            continue;
          Object o = stripHTML(input, srCol);
          if (o != null)
            results.add(o);
        }
        row.put(col, results);
        ...
        Object o = stripHTML(value, srCol);
        if (o != null)
          row.put(col, o);
      }
    }
