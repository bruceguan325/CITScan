...
public class CookieManager {
	...
	public void forceSetCookie(String domain, String path, Date expireDate, String cookieName, String cookieValue) throws IOException {
		...
		if (expireDate != null)
			cookie.put(EXPIRES, dateFormat.format(expireDate));
	}
