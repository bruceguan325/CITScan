...
public class RichMessageMenuReadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			// uri => /wsie/img/webRM/XXX or /wsie/img/webRM/XXX/size
			...
			case 5:
				msgImg = RobotImageFile.getBy(tid, subPath[4], RichMessage.class.getName(), "img/webRM", null);
				menuImg = RobotImageFile.getBy(tid, subPath[4], RichMenu.class.getName(), "img/webRM", null);
				break;
			case 6:
				msgImg = RobotImageFile.getBy(tid, subPath[5], RichMessage.class.getName(), "img/webRM/" + subPath[4],
						null);
				break;
			}
