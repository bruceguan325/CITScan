 ...
 */
public abstract class MyTFIDFSimilarity extends Similarity {
  ...
  private final class TFIDFSimScorer extends SimScorer {
    ...
    public float score(int doc, float freq) {
      ...
      return raw; // 不做原有的 normalize，解決 multivalue QA alts 越多分數越低的問題
      // norms == null ? raw : raw * decodeNormValue(norms.get(doc));  // normalize for field
    }
