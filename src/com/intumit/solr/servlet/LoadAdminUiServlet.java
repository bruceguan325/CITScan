...
public final class LoadAdminUiServlet extends HttpServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    prefix = config.getInitParameter("admin-path-prefix");
    if(prefix==null) {
      prefix = "";
    }
  }
  ...
  public void doGet(HttpServletRequest request,
    ...
    InputStream in = getServletContext().getResourceAsStream(prefix + "/wise-admin.html");
    if(in != null && cores != null) {
      try {
        ...
        String[] replace = new String[] {
            StringEscapeUtils.escapeJavaScript(request.getContextPath() + prefix),
