...
public class QueryElevationComponent extends SearchComponent implements SolrCoreAware {
  ...
  static final String DATASET_ID = "d";
  static final String DONT_HIDE = "dontHide";
  ...
  public void prepare(ResponseBuilder rb) throws IOException {
    ...
    try {
      if(boostStr != null || exStr != null) {
    	...
    	String dsIdStr = params.get(DATASET_ID);
    	boolean dontHide = params.getBool(DONT_HIDE, false);
    	booster = ElevatorSetFacade.getInstance().loadElevationMap(this, dsIdStr, qstr, dontHide); 
    }
    } catch (Exception ex) {
      throw new SolrException( SolrException.ErrorCode.SERVER_ERROR,
