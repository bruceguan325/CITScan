/**
 * @license AngularJS v1.3.0.10-beta
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0.10-beta/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0.10-beta',    // all of these placeholder strings will be replaced by grunt's
